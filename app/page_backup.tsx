...
import { MobileLayout, MobileSection, MobileText, MobileButton, MobileImage } from "@/components/mobile-layout"
...
export default function Home() {
  ...
  return (
    <MobileLayout>
      ...
      {/* Leadership Excellence Section - Mobile Slideshow or Desktop Grid */}
      {isMobile ? (
      ...
      {/* Product Ecosystem Section - Mobile Slideshow or Desktop Showcase */}
      {isMobile ? (
      ...
      <section className="relative py-32 bg-gradient-to-b from-charcoal via-background to-charcoal overflow-hidden">
        ...
        <div className="relative z-10 max-w-[80vw] mx-auto px-6">
          ...
          {/* Future Vision - Three-Year Expansion Plan */}
          {isMobile ? (
            <MobileExpansionSlideshow />
          ) : (
          <motion.div
            className="mb-20"
            initial={{ opacity: 0, y: 50 }}
