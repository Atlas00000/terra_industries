...
export function KallonIntelligenceSection() {
  ...
  const slides = [
    {
      ...
      subtitle: "Advanced AI-Powered Surveillance",
      content: {
        intelligence: [
          {
            title: "Machine Learning Threat Detection",
            description: "Advanced AI algorithms for autonomous threat identification",
            details: ["Object detection", "Vehicle tracking", "Human recognition", "Behavioral analysis"],
            metrics: "99.5% accuracy"
          },
          {
            title: "Real-time Analysis",
            description: "Instant processing and threat assessment capabilities",
            details: ["Edge AI processing", "Real-time alerts", "Instant response", "Live analysis"],
            metrics: "<1s response"
          },
          {
            title: "Pattern Recognition",
            description: "Advanced pattern recognition for predictive threat assessment",
            details: ["Anomaly detection", "Pattern analysis", "Predictive modeling", "Risk assessment"],
            metrics: "Predictive AI"
          },
          {
            title: "Autonomous Monitoring",
            description: "Fully autonomous surveillance operations",
            details: ["24/7 operation", "Self-managing", "Autonomous decisions", "Continuous monitoring"],
            metrics: "100% autonomous"
          }
        ]
      }
    },
    {
      ...
      subtitle: "24/7 Strategic Surveillance",
      content: {
        operations: [
          {
            title: "Continuous Monitoring",
            value: "24/7",
            description: "Uninterrupted surveillance operations",
            details: ["Round-the-clock monitoring", "No downtime", "Continuous coverage", "Persistent surveillance"]
          },
          {
            title: "Threat Detection",
            value: "3km",
            description: "Long-range threat detection capabilities",
            details: ["Extended range detection", "Early warning system", "Threat identification", "Perimeter security"]
          },
          {
            title: "Response Time",
            value: "<1s",
            description: "Ultra-fast threat response capabilities",
            details: ["Instant alerts", "Rapid response", "Real-time coordination", "Immediate action"]
          },
          {
            title: "Operational Efficiency",
            value: "95%",
            description: "High operational efficiency and reliability",
            details: ["System reliability", "Efficient operations", "Cost effectiveness", "Performance optimization"]
          }
        ]
      }
    },
        ...
        deployment: [
          {
            ...
            description: "Strategic positioning for critical asset security",
            details: ["Power plants", "Oil & gas facilities", "Telecommunications", "Transportation hubs"],
            examples: ["Nigerian power infrastructure", "Oil pipeline security", "Critical asset protection"]
          },
          {
            title: "Border Security & Monitoring",
            description: "Comprehensive border surveillance and security",
            details: ["Perimeter monitoring", "Intrusion detection", "Cross-border threats", "Immigration support"],
            examples: ["Nigerian border security", "International borders", "Cross-border operations"]
          },
          {
            title: "Military Applications",
            description: "Strategic military surveillance and defense",
            details: ["Military bases", "Defense installations", "Strategic assets", "Military operations"],
            examples: ["Nigerian military", "Defense contracts", "Strategic partnerships"]
          },
          {
            title: "Commercial Security",
            description: "Business and industrial security solutions",
            details: ["Industrial facilities", "Commercial properties", "Business security", "Asset protection"],
            examples: ["Industrial complexes", "Commercial facilities", "Business security"]
          }
        ]
      }
    }
      ...
      <div className="relative z-10 max-w-[80vw] mx-auto px-6">
        ...
        >
          ...
          >
            ...
            />
            <span className="text-sm font-medium text-primary">AI Intelligence & Operations</span>
          </motion.div>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Advanced AI intelligence, 24/7 surveillance operations, and strategic deployment for critical infrastructure protection
          </motion.p>
        </motion.div>
                  ...
                  {slides[currentSlide].content.intelligence.map((feature, index) => (
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="text-2xl font-bold text-primary">{feature.metrics}</div>
                      </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  {slides[currentSlide].content.operations.map((operation, index) => (
                    <motion.div
                      ...
                      transition={{ delay: 0.3 + index * 0.1, duration: 0.5 }}
                    >
                      <div className="text-3xl font-bold text-primary mb-2">{operation.value}</div>
                      <h4 className="text-lg font-bold text-foreground mb-2">{operation.title}</h4>
                ...
                <div className="space-y-6">
                  {slides[currentSlide].content.deployment.map((deployment, index) => (
                    <motion.div
                      ...
                      transition={{ delay: 0.3 + index * 0.1, duration: 0.5 }}
                    >
                      <h4 className="text-xl font-bold text-foreground mb-3">{deployment.title}</h4>
                      <p className="text-muted-foreground mb-4">{deployment.description}</p>
                      <div className="grid grid-cols-2 gap-3 mb-4">
                        {deployment.details.map((detail, detailIndex) => (
                          <div key={detailIndex} className="flex items-center gap-2 text-sm">
                      ...
                      <div className="space-y-2">
                        ...
                        {deployment.examples.map((example, exampleIndex) => (
            ...
            >
              <div className="relative w-full h-96 lg:h-[500px]">
                <Image
                  ...
                  alt="Kallon AI Intelligence & Operations"
                  fill
              ...
              >
                <div className="text-center">
                  ...
                  <div className="text-xs text-muted-foreground">Edge processing</div>
                </div>
              </motion.div>
            </motion.div>
          </motion.div>
