...
export function MobileIrokoSpecificationsSlideshow() {
  ...
  const slides = [
    {
      ...
      content: [
        ...
        "Weight: 4kg (max takeoff weight)",
        "Dimensions: 500mm x 500mm x 200mm",
        "Propeller: 12-inch carbon fiber",
        "Landing Gear: Retractable carbon fiber"
      ],
    ...
    },
    {
      ...
      content: [
        "Motors: 4x Brushless DC",
        "ESC: 4x 40A Electronic Speed Controllers",
        "Battery: 6S 5000mAh Li-Po",
        "Charging Time: 45 minutes",
        "Power Management: Smart BMS"
      ],
      image: "/Iroko_UAV/Iroko_UAV .png",
    ...
    },
    {
      ...
      content: [
        ...
        "Geofencing: Dynamic no-fly zones",
        "Encryption: AES-256"
      ],
      image: "/Iroko_UAV/Iroko_UAV .png",
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Comprehensive technical details of the Iroko UAV system
          </p>
        </motion.div>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
                ...
                <div className="relative">
                  ...
                  >
                    <div className="text-xs font-bold text-primary">Iroko UAV</div>
